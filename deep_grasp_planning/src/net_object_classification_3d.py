...
dataset_path="C:/cygwin/home/osboxes/dataset/geometrics"

write_objects1="C:/cygwin/home/osboxes/dataset/first"
ready_objects1="C:/cygwin/home/osboxes/dataset/first_ready"
##write_objects2="/home/osboxes/dataset2/second"
##ready_objects2="/home/osboxes/dataset2/second_ready"
##write_objects3="/home/osboxes/dataset2/third"
##ready_objects3="/home//dataset2/third_ready"
##write_objects4="/home/osboxes/dataset2/fourth"
##ready_objects4="/home/osboxes/dataset2/fourth_ready"
##write_objects5="/home/osboxes/dataset2/fifth"
##ready_objects5="/home/osboxes/dataset2/fifth_ready"
##write_objects6="/home/osboxes/dataset2/sixth"
##ready_objects6="/home/osboxes/dataset2/sixth_ready"
##write_objects7="/home/osboxes/dataset2/seventh"
##ready_objects7="/home/osboxes/dataset2/seventh_ready"
##write_objects8="/home/osboxes/dataset2/eighth"
##ready_objects8="/home/osboxes/dataset2/eighth_ready"
##write_objects9="/home/osboxes/dataset2/nineth"
##ready_objects9="/home/osboxes/dataset2/nineth_ready"
##write_objects10="/home/osboxes/dataset2/tenth"
##ready_objects10="/home/osboxes/dataset2/tenth_ready"
...
iterations_complete=200
run_until=datetime.datetime(2018, 10, 29, 13, 30)

output_path="C:/cygwin/home/osboxes/NetResults/hollows/"
...
def inference_4layers(inp):
    conv1=convPoolLayer_Red(inp, 3, 1, 10, 2, 'conv1_class')
    print (conv1)
    conv2=convPoolLayer_Red(conv1, 3, 10, 30, 3, 'conv2_class')
    print (conv2)
    conv3 = convPoolLayer(conv2, 3, 30, 60, 'conv3_class')
    print (conv3)
    #conv4 = convPoolLayer(conv3, 3, 80, 160,'conv4_class')
    #print conv4


    flat=tf.reshape(conv3, [-1,5*5*5*60])
    dens1=denselyConnLayer(flat, 5*5*5*60, 40, 'dense1_class')
    lineal1=denselyConnLayerLineal(dens1, 40, 4, 'lineal1_class')
...
train_writer=tf.summary.FileWriter("C:/cygwin/home/osboxes/tensorboard/hollow/train", sess.graph)
test_writer=tf.summary.FileWriter("C:/cygwin/home/osboxes/tensorboard/hollow/test")
...
while(now<run_until):
    if change==1:
        if folder==1:
          ...
          while os.path.isfile(ready_objects1):
            time.sleep(1)
...
##            train_objects = training.num_examples #added
##            val_objects = validation.num_examples #added
##            batch=training.next_batch(batch_size) # added
